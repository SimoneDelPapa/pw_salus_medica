    ...
    <div className="glass-card login-card">
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          ...
          {/* ====================================================================
              BLOCCO PASSWORD CON ICONE SVG INLINE (INFALLIBILE)
              ==================================================================== */}
          <div className="form-group" style={{ margin: 0 }}>
            <label>Password:</label>
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center', width: '100%' }}>
              
              <i className="fa-solid fa-lock" style={{ position: 'absolute', left: '14px', color: '#93c47d', zIndex: 10, fontSize: '15px' }}></i>
              ...
              >
                ...
                */}
                {showPassword ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="#93c47d" style={{ width: '22px', height: '22px' }}>
